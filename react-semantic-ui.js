  ...
  module.exports.Paginator = React.createClass({
    ...
    render: function() {
      ...
      if (totalPages && totalPages > 1) {
        ...
        var showRightSeparator = (totalPages > totalShowing + 2);
        var showLeftSeparator = typeof index[anchor+1] !== 'undefined';
        ...
        // separators
        if (showLeftSeparator) {
          children.push(anchor, 0, React.DOM.div({className: 'disabled item'}, separator));
        }
        if (showRightSeparator) {
          children.push(children.length-anchor-1, 0, React.DOM.div({className: 'disabled item'}, separator));
        }
